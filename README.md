...
The [first 2B checkpoint](docs/milestone-2b-rays.md) adds A1 ray constraints and exact supported states for a single ray. Scene-wide propagation and complete A1 inference are still to come.
