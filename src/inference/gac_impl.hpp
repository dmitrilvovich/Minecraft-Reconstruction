...
template<class Result,class ProblemType,class DomainsType,class Observer>
Result propagate_gac(const ProblemType& problem,DomainsType domains,InferenceStats& stats,Observer* observer) {
